...
def get_replay_traj(results, ripple_times, position_info,
                    track_graph, classifier):
    '''
    wrote by zilong, to get the replay trajectory for current epoch_key
    '''
    
    all_mental_traj = {}
    all_index = ripple_times.index
    for i, ripple in enumerate(ripple_times.itertuples()):
        #get the replay trajectory for the current ripple
        ...
        all_mental_traj[all_index[i]] = replay_distance_from_center_well
        
    return all_mental_traj   
